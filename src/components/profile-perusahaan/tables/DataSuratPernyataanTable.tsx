...
interface DokumenSuratPernyataanData {
    dokumen: string;
    nomorDokumen: string;
...
interface DataSuratPernyataanTableProps {
...
const DataSuratPernyataanTable: React.FC<DataSuratPernyataanTableProps> = ({ 
    onFileUpload,
    onFileDelete,
    onFileView
}) => {
    const [dokumenData, setDokumenData] = useState<DokumenSuratPernyataanData[]>([
        {
            dokumen: "Surat Pernyataan Kebenaran Seluruh Data",
            nomorDokumen: "",
            penerbitDokumen: "",
            tanggalTerbit: "",
            tanggalBerakhir: "",
    ...
    const handleInputChange = (index: number, field: keyof DokumenSuratPernyataanData, value: string) => {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Data Surat Pernyataan</CardTitle>
                <CardDescription>
                    Upload surat pernyataan yang diperlukan
                </CardDescription>
            </CardHeader>
            <CardContent>
...
export default DataSuratPernyataanTable;