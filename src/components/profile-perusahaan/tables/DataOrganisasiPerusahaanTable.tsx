...
interface DokumenOrganisasiData {
    dokumen: string;
    nomorDokumen: string;
...
interface DataOrganisasiPerusahaanTableProps {
...
const DataOrganisasiPerusahaanTable: React.FC<DataOrganisasiPerusahaanTableProps> = ({ 
    onFileUpload,
    onFileDelete,
    onFileView
}) => {
    const [dokumenData, setDokumenData] = useState<DokumenOrganisasiData[]>([
        { dokumen: "Struktur Organisasi Perusahaan", nomorDokumen: "", penerbitDokumen: "", tanggalTerbit: "", tanggalBerakhir: "", file: null, fileName: "" },
        { dokumen: "Data pegawai tetap dan tidak tetap", nomorDokumen: "", penerbitDokumen: "", tanggalTerbit: "", tanggalBerakhir: "", file: null, fileName: "" },
        { dokumen: "Daftar pengurus perusahaan", nomorDokumen: "", penerbitDokumen: "", tanggalTerbit: "", tanggalBerakhir: "", file: null, fileName: "" },
        { dokumen: "Daftar dan cv tenaga ahli", nomorDokumen: "", penerbitDokumen: "", tanggalTerbit: "", tanggalBerakhir: "", file: null, fileName: "" },
        { dokumen: "Foto terkini kondisi kantor", nomorDokumen: "", penerbitDokumen: "", tanggalTerbit: "", tanggalBerakhir: "", file: null, fileName: "" }
    ]);

    const handleInputChange = (index: number, field: keyof DokumenOrganisasiData, value: string) => {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Data Organisasi Perusahaan</CardTitle>
                <CardDescription>
                    Upload dokumen organisasi dan struktur perusahaan
                </CardDescription>
            </CardHeader>
            <CardContent>
...
export default DataOrganisasiPerusahaanTable;