...
interface DataKeuanganPerusahaanTableProps {
...
const DataKeuanganPerusahaanTable: React.FC<DataKeuanganPerusahaanTableProps> = ({ 
    onFileUpload,
    onFileDelete,
    onFileView
}) => {
    const [dokumenData, setDokumenData] = useState<DokumenKeuanganData[]>([
        { dokumen: "Laporan Keuangan", nomorDokumen: "", penerbitDokumen: "", tanggalTerbit: "", tanggalBerakhir: "", file: null, fileName: "" },
        { dokumen: "Rekening Koran Bank", nomorDokumen: "", penerbitDokumen: "", tanggalTerbit: "", tanggalBerakhir: "", file: null, fileName: "" }
    ]);

    const handleInputChange = (index: number, field: keyof DokumenKeuanganData, value: string) => {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Data Keuangan Perusahaan</CardTitle>
                <CardDescription>
                    Upload dokumen keuangan perusahaan
                </CardDescription>
            </CardHeader>
            <CardContent>
...
export default DataKeuanganPerusahaanTable;