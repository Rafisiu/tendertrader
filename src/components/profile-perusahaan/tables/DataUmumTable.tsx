...
const DataUmumTable: React.FC<DataUmumTableProps> = ({ 
    onFileUpload,
    onFileDelete,
    onFileView
}) => {
    const [dokumenData, setDokumenData] = useState<DokumenUmumData[]>([
        {
            dokumen: "Surat Permohonan Rekanan",
            nomorDokumen: "",
            penerbitDokumen: "",
            tanggalTerbit: "",
            tanggalBerakhir: "",
        ...
        {
            dokumen: "Data Profil Perusahaan",
            nomorDokumen: "",
            penerbitDokumen: "",
            tanggalTerbit: "",
            tanggalBerakhir: "",
        ...
        {
            dokumen: "Surat TDR lama (apabila perpanjangan)",
            nomorDokumen: "",
            penerbitDokumen: "",
            tanggalTerbit: "",
            tanggalBerakhir: "",
    ...
    const handleInputChange = (index: number, field: keyof DokumenUmumData, value: string) => {
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Upload dokumen umum yang diperlukan untuk registrasi
                </CardDescription>
            </CardHeader>
            <CardContent>
